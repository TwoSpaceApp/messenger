...
| **Flutter**       | `3.38.8`    | Фреймворк для кроссплатформенной разработки (iOS, Android, Windows, macOS, Linux) |
| **Node.js**       | `24.11.0`   | Среда выполнения для серверных скриптов и вспомогательных сервисов |
| **DevTools**      | `2.51.x`    | Инструменты отладки и профилирования от Google для Flutter/Dart |
