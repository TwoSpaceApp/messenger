...
class AppLocalizationsEs extends AppLocalizations {
  ...
  @override
  String get emailOrUsernameLabel => 'Correo o nombre de usuario';
  ...
  String get validationEnterEmailOrUsername =>
      'Ingrese correo o nombre de usuario';
  ...
  String get matrixTooltip =>
      'Matrix es un protocolo abierto de mensajería federada';
  ...
  String get matrixIdDescription =>
      'Ingrese el Matrix ID del usuario (ej. @user:server.com)';

  @override
  String get matrixIdLabel => 'Matrix ID del usuario';
  ...
  @override
  String get matrixIdExplanation => 'Matrix ID consiste en @usuario:server.com';
