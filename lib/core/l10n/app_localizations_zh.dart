...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get callsDemoBannerVideoMessage => '视频通话目前仅作为界面原型展示，远端视频流暂不可用，但你的本地摄像头预览可以正常工作。';

  @override
  String get callsCameraPermissionMessage => '请允许访问摄像头，以便在视频通话中显示你的本地预览。';

  @override
  String get callsCameraPermissionSettingsMessage => '摄像头权限已被阻止。请打开系统设置以启用本地视频预览。';
  ...
  @override
  String get backgroundOptimizationDisabledMessage => 'TwoSpace 检测到持续掉帧，因此关闭了较重的背景效果，以保持滚动和聊天操作流畅。';
  ...
  @override
  String get twoFactorSetupDescription => '在认证器应用中扫描二维码，保存恢复短语，然后使用新的 TOTP 代码完成确认。';
